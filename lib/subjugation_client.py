...
def check_participant(parameter, sid):
    ...
    url = 'http://v267b.cc.mobimon.com.tw/subjugation/check_participant'
    cookies = {'sid': sid}
...
def try_subjugation(parameter, sid):
    poster = utils.poster.Poster
    url = 'http://v267b.cc.mobimon.com.tw/subjugation/try'
    cookies = {'sid': sid}
    headers = {'Cookie': 'sid={0}'.format(sid)}
    data = {
        'brave': 0,
...
def start_subjugation(parameter, sid):
    poster = utils.poster.Poster
    url = 'http://v267b.cc.mobimon.com.tw/subjugation/entry'
    cookies = {'sid': sid}
    headers = {'Cookie': 'sid={0}'.format(sid)}
    data = {
        'bid': parameter['bid'],
...
def finish_subjugation(parameter, sid):
    ...
    poster = utils.poster.Poster
    url = 'http://v267b.cc.mobimon.com.tw/subjugation/result'
    cookies = {'sid': sid}
    headers = {'Cookie': 'sid={0}'.format(sid)}
