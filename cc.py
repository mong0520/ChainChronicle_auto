...
class ChainChronicleAutomation():
    ...
    def CC_PlayQuest(self, qtype, qid, count, bRaid, bSell, maxEventPoint):
        ...
        while True:
            ...
            if result['res'] == 0:
                self.logger.info("#{0} - 戰鬥完成!".format(current))
